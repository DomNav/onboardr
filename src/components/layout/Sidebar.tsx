...
import { 
  BarChart, BarChart3, Wallet, Globe, 
  DollarSign, Settings, ChevronRight, ChevronLeft, Home, TrendingUp
} from 'lucide-react';
    ...
    <aside className={cn(
      ...
      <div className="p-4 border-t border-sidebar-border">
        <div className={cn(
          ...
          <p className="font-medium">DeFi Status</p>
          <p>Protocols active</p>
          <p className="text-[10px]">24/7 trading</p>
        </div>
      </div>
    </aside>
  );
